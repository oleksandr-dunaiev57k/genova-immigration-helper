...
const docs: Record<string, Record<Lang, DocPageData>> = {
  "codice-fiscale": {
    ru: {
      ...
      steps: [
        { n: 1, title: "Найди ближайшую Agenzia delle Entrate", body: "В Генуе: Via De Marini 1, 16149 Genova. Часы работы: пн–вт 8:30–13:00, 14:00–16:30; ср 8:30–13:00." },
    ...
    ua: {
      ...
      steps: [
        { n: 1, title: "Знайди найближче Agenzia delle Entrate", body: "У Генуї: Via De Marini 1, 16149 Genova. Години роботи: пн–вт 8:30–13:00, 14:00–16:30; ср 8:30–13:00." },
  ...
  "permesso-di-soggiorno": {
    ru: {
      ...
      steps: [
        ...
        { n: 4, title: "Приди в Questura в назначенный день", body: "В Questura снимут отпечатки пальцев, сфотографируют и проверят документы. Дадут талон для отслеживания статуса.", tip: "Questura Genova: Via Bartolomeo Bosco 24. Возьми с собой ВСЕ оригиналы документов." },
    ...
    ua: {
      ...
      steps: [
        ...
        { n: 4, title: "Прийди до Questura у призначений день", body: "У Questura знімуть відбитки пальців, сфотографують та перевірять документи.", tip: "Questura Genova: Via Bartolomeo Bosco 24. Візьми з собою ВСІ оригінали документів." },
  ...
  "tessera-sanitaria": {
    ru: {
      ...
      steps_title: "Пошаговая инструкция",
      steps: [
        { n: 1, title: "Иди в ASL (Azienda Sanitaria Locale)", body: "В Генуе главный офис: Via Bertani 4. Также есть районные офисы по всему городу." },
    ...
    ua: {
      ...
      steps_title: "Покрокова інструкція",
      steps: [
        { n: 1, title: "Іди до ASL (Azienda Sanitaria Locale)", body: "У Генуї головний офіс: Via Bertani 4. Також є районні офіси по всьому місту." },
  ...
  "residenza": {
    ru: {
      ...
      steps_title: "Пошаговая инструкция",
      steps: [
        { n: 1, title: "Запишись в Comune di Genova", body: "Записаться можно онлайн на сайте comune.genova.it или прийти лично в ближайший sportello anagrafe." },
    ...
    ua: {
      ...
      steps_title: "Покрокова інструкція",
      steps: [
        { n: 1, title: "Запишись до Comune di Genova", body: "Записатися можна онлайн на сайті comune.genova.it або прийти особисто до найближчого sportello anagrafe." },
  ...
  "carta-identita": {
    ...
    ua: {
      ...
      steps_title: "Покрокова інструкція",
      steps: [
        { n: 1, title: "Запишись до Comune онлайн", body: "Запис через сайт Comune di Genova або агрегатор prenotami.it. Без запису зазвичай не приймають.", tip: "Записи бувають завантажені на 2–3 тижні вперед. Бронюй заздалегідь." },
